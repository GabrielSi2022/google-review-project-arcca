...
// export const getInformations = async (event: any) => {
...
//     console.log(
//       `Done fetching reviews for store ${i}... (${(
//         (Date.now() - timer) /
//         1000
//       ).toFixed(2)} s)`
//     );
...
//     console.log(
//       `Done adding reviews in DB for store ${i}... (${(
//         (Date.now() - timer) /
//         1000
//       ).toFixed(2)} s)`
//     );
...
//   console.log(
//     `Tempo total de execução: (${((Date.now() - runTime) / 1000).toFixed(2)} s)`
//   );
...
//           (reviewUnit[0][2][15] &&
//             reviewUnit[0][2][15][0][0]
//               .replaceAll(/\n$/g, "")
//               .replaceAll(/\n/g, " ")) ||
//             null,
//           // ownerResponse
//           (reviewUnit[0][3][14] &&
//             reviewUnit[0][3][14][0][0]
//               .replaceAll(/\n$/g, "")
//               .replaceAll(/\n/g, " ")) ||
//             null,
//         ];
...
//       "postgresql://postgres:postpass@postgres-nema-reviews.c9wqu22m2tmd.us-east-1.rds.amazonaws.com:5432/nema";
//     const pool = new Pool({
//       connectionString,
//       ssl: {
...
//       const response = await axios.post("/reviews/create", reviews);
